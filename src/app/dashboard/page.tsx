...
import { toastUtils } from "@/utils/toastUtils";
    ...
    const ChartDataDashboard = dynamic(() => import("./components/chartDataDashboard"), {
      ssr: false,
      loading: () => (
                ...
                <ul className="space-y-4 flex flex-col justify-start py-2">
                  <li>
                    ...
                    >
                      ...
                      {isSidebarOpen && <motion.span variants={textVariants}>Dashboard</motion.span>}
                    </Link>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      {isSidebarOpen && <motion.span variants={textVariants} >Transaction History</motion.span>}
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      {isSidebarOpen && <motion.span variants={textVariants}>Settings</motion.span>}
                    </a>
                  </li>
                </ul>
              </nav>
                ...
                <div className="flex flex-row flex-wrap gap-2 items-center justify-center text-white rounded-lg shadow-lg p-4">
                  <button
                    ...
                    className={`px-4 py-2 border font-bold border-zinc-600 ${
                      isDashboardOpen ? "bg-zinc-100 text-zinc-800" : "text-gray-300"
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 auto-rows-min w-full">
                ...
                <div className="min-h-[200px] bg-yellow-500 text-white p-4">
                  <p>
                    ...
                    assumenda explicabo animi voluptate repellendus praesentium fuga!
                    Expedita voluptate possimus similique rerum, earum labore libero
                    iure deleniti eligendi optio adipisci ut magnam recusandae laborum
                    omnis impedit? Fugiat aliquid nulla quisquam! Totam aliquam eius rem
                    necessitatibus odio quidem quo nisi consequuntur provident!
                  </p>
                </div>
                ...
                <div className="bg-indigo-500 text-white flex items-center justify-center p-4">
                  <p>
                    ...
                    Repellendus alias cum ipsam delectus, quis ipsa nostrum, inventore
                    repudiandae quos iure vitae veniam. Quidem enim quaerat magnam
                    itaque? Explicabo dolores commodi veritatis maxime maiores
                    repudiandae ea similique in
                  </p>
                </div>
